...
#__________EHC CYBER 99 
print("walcome to SEE MORE EHC CYBER 99 Imon&Tutul")
logo = ("""
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :NIX = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :NIX = '√ 2009'
        elif uid[:8] in ['10000000']        :NIX = '√ 2009'
        ...
        elif uid[:6] in ['100001']          :NIX = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :NIX = '√ 2011/2012'
        elif uid[:6] in ['100004']          :NIX = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :NIX = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :NIX = '√ 2014/2015'
        elif uid[:6] in ['100009']          :NIX = '√ 2015'
        elif uid[:5] in ['10001']           :NIX = '√ 2015/2016'
        elif uid[:5] in ['10002']           :NIX = '√ 2016/2017'
        elif uid[:5] in ['10003']           :NID = '√ 2018/2019'
        elif uid[:5] in ['10004']           :NIX = '√ 2019/2020'
        elif uid[:5] in ['10005']           :ALAMIN = '√ 2020'
        elif uid[:5] in ['10006','10007','']:NIX = '√ 2021'
        elif uid[:5] in ['10008']           :NIX = '√ 2022'
        elif uid[:5] in ['10009']           :NIX = '√ 2023'
        else:NIX=''
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
#____((𝑼𝑷𝑫𝑨𝑻𝑬-𝑺𝒀𝑺𝑻𝑬𝑴-𝑩𝑶𝑺𝑺-Imon&Tutul))            
